package com.bank.bian.channelactivityhistory.model;
...
/**
 * The BIAN control record for this service domain: "Channel Activity Log Maintenance Agreement".
 *
 ...
 * to its asset type (Channel Activity Log). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Channel Activity Log Maintenance Agreement";
